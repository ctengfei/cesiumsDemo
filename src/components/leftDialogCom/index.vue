                ...
                <div class="firstBlock">
                    ...
                    <div class="cards" v-if="mapType != 'two'">
                        ...
                        <div style="display: flex; flex-wrap: wrap">
                            ...
                            <el-checkbox v-model="ObliquePhotographyChecked" @change="ObliquePhotography">倾斜摄影</el-checkbox>
...
export default {
    ...
    data() {
        return {
            ...
            ObliquePhotographyChecked:false,//坝体倾斜摄影
        };
    },
    computed: {
    ...
    methods: {
        ...
        ObliquePhotography(val) {
            //倾斜摄影坝体显示
            this.$bus.emit('ObliquePhotography', val);
        }
        // pointsChange(val){
